...
def generate_launch_description():
    package_dir = get_package_share_directory('webots_finalproject')
    ...
    return LaunchDescription([
        ...
        Node(
            package='webots_finalproject',  # The package name
            executable='webots_finalproject',  # The node executable name
            name='webots_finalproject_node',  # Optional: Custom node name
